        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: width * 0.01),
              const StyledBody(
                'Note: This may affect availability and pricing.',
              ...
              GestureDetector(
                ...
                child: Padding(
                  ...
                  child:
                      Image.asset('assets/img/backgrounds/bangkok_skyline.png'),
                ),
              ),
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Provider.of<ItemStoreProvider>(context, listen: false)
                      .saveRenter(toSave);
                  // Provider.of<ItemStoreProvider>(context, listen: false).setRegion('SINGAPORE');
                  callback(true);
                  Navigator.pop(context);
                },
                child: Padding(
                  padding:
                      EdgeInsets.fromLTRB(width * 0.04, 0, width * 0.04, 0),
                  child: Image.asset(
                      'assets/img/backgrounds/singapore_skyline.png'),
                ),
              ),
            ],
          ),
