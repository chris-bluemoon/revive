  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return (historyFittingsList.isNotEmpty)
              ? MyHistoryFittingsImageWidget(
                  historyFittingsList[index],
                  historyFittingsList[index].itemArray,
                  historyFittingsList[index].bookingDate,
                  historyFittingsList[index].price,
                  historyFittingsList[index].status)
