...
class MyVerifyAdminImageWidget extends StatefulWidget {
  ...
  @override
  State<MyVerifyAdminImageWidget> createState() =>
      _MyVerifyAdminImageWidgetState();
}
              ...
              children: [
                Row(
                  children: [
                    ...
                    if (widget.renter.verified == 'pending')
                      ElevatedButton(
                          onPressed: () {
                ...
                Row(
                  children: [
                    SizedBox(
                        width: width * 0.2,
                        child: const StyledBody('Email',
                            color: Colors.grey, weight: FontWeight.normal)),
                    SizedBox(width: width * 0.01),
                    StyledBody(widget.renter.email,
                        color: Colors.grey, weight: FontWeight.normal),
                  ],
                ),
                Row(
                ...
                Row(
                  children: [
                    SizedBox(
                        width: width * 0.2,
                        child: const StyledBody('Created',
                            color: Colors.grey, weight: FontWeight.normal)),
                    SizedBox(width: width * 0.01),
                    StyledBody(widget.renter.creationDate,
                        color: Colors.grey, weight: FontWeight.normal),
                  ],
                ),
                Row(
                  children: [
                    SizedBox(
                        ...
                        child: const StyledBody('Status',
                            color: Colors.grey, weight: FontWeight.normal)),
                    SizedBox(width: width * 0.01),
                    StyledBody(widget.renter.verified,
                        color: Colors.grey, weight: FontWeight.normal),
                  ],
                ),
              ],
