...
class _CreateItemState extends State<CreateItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                              ...
                              child: ListTile(
                                ...
                                leading: GestureDetector(
                                    ...
                                    child: Icon(Icons.close,
                                        ...
                                        size: width * 0.04)),
                                title:
                                    const Center(child: StyledBody('COLOURS')),
                              ),
                            ),
                            Expanded(
                              child: SizedBox(
                        ...
                        child: Column(
                          children: [
                            ...
                            BlackButton('SAVE', width * 0.1, () {
                              Navigator.pop(context);
                              setState(() {
                                retailPriceValue = retailPriceController.text;
                              });
                            }),
                          ],
                        ),
      ...
      bottomNavigationBar: Consumer(
        builder:
            (BuildContext context, CreateItemProvider value, Widget? child) {
          return Container(
  ...
  viewImage(int n) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => (ViewImage(_images, n))));
  }
